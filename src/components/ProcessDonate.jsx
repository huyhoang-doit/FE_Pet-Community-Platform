        ...
        <div className="block-body">
          <div className="block-row">
            <div className="donate-progressBarContainer mb-2 h-6 bg-gray-200 rounded-full overflow-hidden relative">
              <div
                className={`donate-progressBarContainer-bar h-full transition-all duration-600 ease-out relative animate-pulse
                  ${(campaign?.currentAmount / campaign?.targetAmount) * 100 >= 100 
                    ...
                    : (campaign?.currentAmount / campaign?.targetAmount) * 100 >= 75
              ...
              >
                <div className="absolute inset-0 bg-white/20 animate-[shimmer_2s_infinite] bg-[length:50%_100%] bg-no-repeat bg-[100%_0] motion-safe:transition-all" 
                  style={{
            ...
            <div className="mt-6 grid grid-cols-2 gap-2 text-sm">
              <div className="flex flex-col p-3 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 shadow-sm">
                ...
                <span className="text-gray-700">{new Date(campaign?.startDate).toLocaleDateString('vi-VN', {
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric'
                })}</span>
              ...
              <div className="flex flex-col p-3 rounded-lg bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-100 shadow-sm">
                ...
                <span className="text-gray-700">{new Date(campaign?.endDate).toLocaleDateString('vi-VN', {
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric'
                })}</span>
