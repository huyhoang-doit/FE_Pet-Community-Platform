      ...
      <Row gutter={[16, 16]}>
        <Col span={8}>
          ...
          >
            <Statistic
              title={
                <div className="text-lg font-medium">Tổng số người dùng</div>
              }
              value={totalUsers}
        ...
        <Col span={8}>
          ...
          >
            <Statistic
              title={
                <div className="text-lg font-medium">Tổng quyên góp cả năm</div>
              }
            ...
            <div className="mt-4 bg-gradient-to-r from-yellow-50 to-purple-50 p-2 rounded text-sm text-yellow-700">
              <PawPrintIcon className="inline-block w-4 h-4 mr-1" /> Hỗ trợ cho
              các bé thú cưng
            </div>
          </Card>
        </Col>
